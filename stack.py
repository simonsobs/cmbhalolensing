...
for j,task in enumerate(my_tasks):
    ...
    with bench.show("each cluster"):
        ...
        if np.any(ivar_90 <= 1e-10): 
            ...
            io.plot_img(ivar_90,f'{debugdir}act_90_err_ivar_large_var_{task}.png',arc_width=args.stamp_width_arcmin,xlabel='$\\theta_x$ (arcmin)',ylabel='$\\theta_y$ (arcmin)')
            continue
        ...
        if np.any(astamp_150 >= 1e3) or np.any(astamp_90 >= 1e3): 
            ...
            io.plot_img(astamp_150,f'{debugdir}act_150_err_stamp_large_stamp_{task}.png',arc_width=args.stamp_width_arcmin,xlabel='$\\theta_x$ (arcmin)',ylabel='$\\theta_y$ (arcmin)')
            io.plot_img(astamp_90,f'{debugdir}act_90_err_stamp_large_stamp_{task}.png',arc_width=args.stamp_width_arcmin,xlabel='$\\theta_x$ (arcmin)',ylabel='$\\theta_y$ (arcmin)')
            continue
        try:
            ...
            io.plot_img(astamp_150,f'{debugdir}act_150_err_stamp_an_stamp_{task}.png',arc_width=args.stamp_width_arcmin,xlabel='$\\theta_x$ (arcmin)',ylabel='$\\theta_y$ (arcmin)')
            io.plot_img(astamp_90,f'{debugdir}act_90_err_stamp_an_stamp_{task}.png',arc_width=args.stamp_width_arcmin,xlabel='$\\theta_x$ (arcmin)',ylabel='$\\theta_y$ (arcmin)')
            continue
        ...
        if not(np.all(np.isfinite(pstamp))): 
            ...
            io.plot_img(pstamp,f'{debugdir}planck_err_stamp_notfinite_{task}.png',arc_width=args.stamp_width_arcmin,xlabel='$\\theta_x$ (arcmin)',ylabel='$\\theta_y$ (arcmin)')
            continue
        ...
        if np.any(np.abs(kappa) > 15): 
            ...
            io.plot_img(kappa,f'{debugdir}kappa_err_stamp_large_kappa_{task}.png',arc_width=args.stamp_width_arcmin,xlabel='$\\theta_x$ (arcmin)',ylabel='$\\theta_y$ (arcmin)')
            io.plot_img(astamp_150,f'{debugdir}act_150_err_stamp_large_kappa_{task}.png',arc_width=args.stamp_width_arcmin,xlabel='$\\theta_x$ (arcmin)',ylabel='$\\theta_y$ (arcmin)')
            continue
...
if rank==0:
    ...
    kmap = s.stacks['kmap']*s.stack_count['kmap'] / V1
    ...
    kstack = (s.stacks['wk_real'] + 1j*s.stacks['wk_imag']) / s.stacks['wk_iwt']
